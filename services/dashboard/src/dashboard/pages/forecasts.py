...
_CHART_NOTE = (
    "Каждая точка — 5-дн волатильность, заканчивающаяся этой датой; линия факта доходит "
    "до сегодня (вертикаль «сегодня»). Пунктир — прогноз на 5 дней вперёд, исход ещё не созрел."
)
